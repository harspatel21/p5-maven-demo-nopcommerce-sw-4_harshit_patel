...
public class ElectronicsPageTest extends BaseTest {
    ...
    public void TheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        electronicsPage.fillingMandatoryFields("Enter Fist Name", "Raja", By.id("FirstName"));
        electronicsPage.fillingMandatoryFields("Enter Last Name", "Ram", By.id("LastName"));
        electronicsPage.selectByDropDown("Selecting Birth Date", By.name("DateOfBirthDay"), "9");
        Thread.sleep(1000);
        electronicsPage.selectByDropDown("Selecting Birth Month", By.name("DateOfBirthMonth"), "December");
        Thread.sleep(1000);
        electronicsPage.selectByDropDown("Selecting Birth Year", By.name("DateOfBirthYear"), "1985");
        electronicsPage.randomEmailGeneratorAndSendText(By.id("Email"), "Raja", "Ram");
        electronicsPage.randomPasswordGeneratorAndSendText(By.id("Password"), "Ram");
        electronicsPage.randomPasswordGeneratorAndSendText(By.id("ConfirmPassword"), "Ram");
        ...
        electronicsPage.fillingMandatoryFields("Entering city", "Surat", By.id("BillingNewAddress_City"));
        electronicsPage.fillingMandatoryFields("Entering Address1", "105 Gandhi Chowk", By.id("BillingNewAddress_Address1"));
        electronicsPage.fillingMandatoryFields("Entering Zip Code", "253015", By.id("BillingNewAddress_ZipPostalCode"));
        electronicsPage.fillingMandatoryFields("Entering Phone number", "9879965425", By.id("BillingNewAddress_PhoneNumber"));
        ...
        electronicsPage.fillingMandatoryFields("Enter card holder name", "Raja Ram", By.id("CardholderName"));
        electronicsPage.fillingMandatoryFields("Enter card number", "4144586361193201", By.id("CardNumber"));
        electronicsPage.selectByDropDown("Select expiry month", By.id("ExpireMonth"), "08");
        electronicsPage.selectByDropDown("Select expiry year", By.id("ExpireYear"), "2029");
        electronicsPage.fillingMandatoryFields("Entering Credit Card Code", "875", By.id("CardCode"));
